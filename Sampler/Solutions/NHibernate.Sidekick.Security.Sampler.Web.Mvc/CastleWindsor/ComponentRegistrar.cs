...
namespace NHibernate.Sidekick.Security.Sampler.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("NHibernate.Sidekick.Security.Sampler.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("NHibernate.Sidekick.Security.Sampler.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("NHibernate.Sidekick.Security.Sampler.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("NHibernate.Sidekick.Security.Sampler.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("NHibernate.Sidekick.Security.Sampler.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("NHibernate.Sidekick.Security.Sampler.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
